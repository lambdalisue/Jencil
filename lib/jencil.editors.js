(function() {
  ...
  */
  ...
  namespace('Jencil.editors', function(exports) {
    var EditorBase, InitializerBase, Widget, changeEditor;
    ...
    exports.InitializerBase = InitializerBase = (function() {
      InitializerBase.prototype.requires = [];
      InitializerBase.prototype.stylesheets = [];
      InitializerBase.prototype.options = [];
      function InitializerBase(jencil) {
        var i, _ref, _ref2;
        for (i = 0, _ref = this.requires.length; 0 <= _ref ? i < _ref : i > _ref; 0 <= _ref ? i++ : i--) {
          this.requires[i][0] = jencil.abspath(this.requires[i][0]);
        }
        for (i = 0, _ref2 = this.stylesheets.length; 0 <= _ref2 ? i < _ref2 : i > _ref2; 0 <= _ref2 ? i++ : i--) {
          this.stylesheets[i][0] = Jencil.theme.abspath(this.stylesheets[i][0]);
        }
      }
