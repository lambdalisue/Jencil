(function() {
  ...
  */
  ...
  namespace('Jencil.editors', function(exports) {
    var EditorBase, Initializer, Loader, Widget, changeEditor;
    ...
    exports.Loader = Loader = (function() {
      __extends(Loader, Widget);
      function Loader(jencil) {
        Loader.__super__.constructor.call(this, jencil, 'jencil-editor');
