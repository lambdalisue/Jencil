...
function(){return this.jencil.workspace.editor};b.prototype.clickBefore=function(){};b.prototype.click=function(){};b.prototype.clickAfter=function(){};return b}();h.MarkupButtonBase=function(){function b(){b.__super__.constructor.apply(this,arguments)}j(b,f);b.prototype.clickAfter=function(){return this.editor().update()};return b}();h.Separator=function(){function b(e){b.__super__.constructor.call(this,e,"separator","span");this.$element.append(i("<span>|</span>"))}j(b,d);return b}();h.ExecButton=
function(){function b(e,c){var a,g;a=c[0];g=c[1];this._click=c[2];this._clickBefore=c[3];this._clickAfter=c[4];b.__super__.constructor.call(this,e,a,g)}j(b,f);b.prototype.clickBefore=function(){return this._clickBefore(this.editor())};b.prototype.click=function(){return this._click(this.editor())};b.prototype.clickAfter=function(){return this._clickAfter(this.editor())};return b}();return h.PreviewButton=function(){function b(e){b.__super__.constructor.call(this,e,"preview","Preview")}j(b,f);b.prototype.click=
function(){var b,c;b=this.editor();(c=b.preview)!=null&&c.toggle();return b.relocate()};return b}()});namespace("Jencil.editor",function(h){var f,d,b,e;d=Jencil.widget.Widget;b=function(b){return b.outerWidth(!0)-b.width()};e=function(b){return b.outerHeight(!0)-b.height()};h.use=function(b,a,e){var d,f,h,j,k;e==null&&(e=void 0);f=function(){var e,d;e=Jencil.editor[a].extras;if((e!=null?e.options:void 0)!=null)b.options.extras=i.extend(!0,e.options,(d=b.options.extras)!=null?d:{});(e!=null?e.stylesheets:
void 0)!=null&&Jencil.theme.includeall(e.stylesheets);return(e!=null?e.requires:void 0)!=null?Jencil.utils.script.loadall(e.requires,function(){return h()}):h()};h=function(){var d;d=Jencil.editor[a];if(b.workspace.editor!=null)b.workspace.editor.$element.remove(),b.workspace.editor=null;d=new d(b);b.workspace.append(d);b.workspace.editor=d;d.init();if(e!=null)return e()};return a instanceof Array?(k=a,a=k[0],j=k[1],d=k[2],Jencil.utils.script.load(j,d,function(){return f()})):f()};h.EditorBase=f=
...
d)};return c}();h.SinglePaneEditorBase=function(){function c(a,b,e){this.pane=e;c.__super__.constructor.call(this,a,b);this.pane.$element.appendTo(this.$element);this.pane.$element.addClass("jencil-pane");this.$element.addClass("jencil-siglepane-editor")}j(c,f);c.prototype.init=function(){this.pane.init();return c.__super__.init.call(this)};c.prototype.update=function(){this.pane.update();return c.__super__.update.call(this)};c.prototype.relocate=function(){var a,d,f,h;c.__super__.relocate.call(this);
d=b(this.pane.$element);f=e(this.pane.$element);h=this.$element.width();a=this.$element.height();this.pane.$element.width(h-d);return this.pane.$element.height(a-f)};return c}();return h.DualPaneEditorBase=function(){function c(a,b,e,d,f){this.lhspane=e;this.rhspane=d;this.panedir=f!=null?f:"horizontal";c.__super__.constructor.call(this,a,b);this.lhspane.$element.appendTo(this.$element);this.rhspane.$element.appendTo(this.$element);this.lhspane.$element.addClass("jencil-lhspane");this.rhspane.$element.addClass("jencil-rhspane");
this.$element.addClass("jencil-panedir-"+this.panedir)}j(c,f);c.prototype.init=function(){this.lhspane.init();this.rhspane.init();return c.__super__.init.call(this)};c.prototype.update=function(){this.lhspane.update();this.rhspane.update();return c.__super__.update.call(this)};c.prototype.relocate=function(){var a,d,f,h,i,j;c.__super__.relocate.call(this);this.lhspane.isVisible()&&this.rhspane.isVisible()?(this.$element.removeClass("jencil-singlepane-editor"),this.$element.addClass("jencil-dualpane-editor")):
(this.$element.addClass("jencil-singlepane-editor"),this.$element.removeClass("jencil-dualpane-editor"));d=b(this.lhspane.$element);h=b(this.rhspane.$element);f=e(this.lhspane.$element);i=e(this.rhspane.$element);j=this.$element.width();a=this.$element.height();this.lhspane.isVisible()&&this.rhspane.isVisible()?this.panedir==="horizontal"?(this.lhspane.$element.css({"float":"left"}),this.rhspane.$element.css({"float":"right"}),this.lhspane.$element.width(j/2-d),this.rhspane.$element.width(j/2-h),
this.lhspane.$element.height(a-f),this.rhspane.$element.height(a-i)):(this.lhspane.$element.css({"float":"none"}),this.rhspane.$element.css({"float":"none"}),this.lhspane.$element.width(j-d),this.rhspane.$element.width(j-h),this.lhspane.$element.height(a/2-f),this.rhspane.$element.height(a/2-i)):this.lhspane.isVisible()?(this.lhspane.$element.css({"float":"none"}),this.lhspane.$element.width(j-d),this.lhspane.$element.height(a-f)):(this.rhspane.$element.css({"float":"none"}),this.rhspane.$element.width(j-
h),this.rhspane.$element.height(a-i));this.lhspane.relocate();return this.rhspane.relocate()};return c}()});namespace("Jencil.editor.pane",function(h){var f,d;d=Jencil.widget.Widget;h.EditorPane=f=function(){function b(e,c,a){this.editor=a;b.__super__.constructor.call(this,e,c);this._updateCallbacks=[]}j(b,d);b.prototype.init=function(){return this};b.prototype.update=function(b){var c,a,d,f;if(b!=null)return this._updateCallbacks.push(b);else{d=this._updateCallbacks;f=[];for(c=0,a=d.length;c<a;c++)b=
d[c],f.push(b());return f}};b.prototype.isVisible=function(){return this.$element.is(":visible")};b.prototype.show=function(){this.update();this.editor.$element.removeClass(""+this.cls+"-invisible");return this.$element.show()};b.prototype.hide=function(){this.editor.$element.addClass(""+this.cls+"-invisible");return this.$element.hide()};b.prototype.toggle=function(){return this.isVisible()?this.hide():this.show()};b.prototype.relocate=function(){};return b}();return h.PreviewPane=function(){function b(e,
c){b.__super__.constructor.call(this,e,"jencil-preview-pane",c);this.$element.css({position:"relative"});this.$surface=i("<div>").addClass("surface");this.$surface.appendTo(this.$element);this.$surface.css({width:"100%",height:"100%",border:"",margin:0,padding:0,overflow:"auto"})}j(b,f);b.prototype._writeContent=function(b){var c,a;c=k(function(a){return this.$surface.html(a.replace("{{content}}",b))},this);return this._previewTemplate==null?(a=Jencil.utils.path.abspath(this.jencil.options.extras.previewTemplatePath),
this.$surface.load(a,k(function(a){this._previewTemplate=a;return c(a)},this))):c(this._previewTemplate)};b.prototype.update=function(){var d,c;d=k(function(a){this._writeContent(a);return d.__super__.constructor.call(this)},this);d.__super__=b.__super__.update.apply(this,arguments);c=k(function(){var a,b;a=this.editor.getValue();return((b=this.jencil.profile.extras)!=null?b.previewParserPath:void 0)!=null?(a=encodeURIComponent(a),i.ajax({url:Jencil.utils.path.abspath(this.jencil.profile.extras.previewParserPath),
...
8)return this.$surface.height(this.$element.height())};return b}()});namespace("Jencil.editor.pane",function(h){var f;f=Jencil.editor.pane.EditorPane;return h.TextareaPane=function(){function d(b,e){d.__super__.constructor.call(this,b,"jencil-textarea-pane",e);this.$element.css({position:"relative"});this.$surface=i("<textarea>").addClass("surface");this.$surface.appendTo(this.$element);this.$surface.css({width:"100%",height:"100%",border:"none",margin:0,padding:0,resize:"none",outline:"none"});this.$surface.bind("keyup keypress click change blur enter",
k(function(){return this.update()},this));this.controller=new Textarea(this.$surface)}j(d,f);d.prototype.init=function(){i.fn.tabby!=null&&this.$element.tabby();return d.__super__.init.call(this)};d.prototype.relocate=function(){d.__super__.relocate.call(this);if(Jencil.utils.detector.browser==="Explorer"&&Jencil.utils.detector.version<8)return this.$surface.height(this.$element.height())};d.prototype.getValue=function(){return this.controller.getValue()};d.prototype.setValue=function(b){return this.controller.setValue(b)};
return d}()});namespace("Jencil.editor",function(h){var f,d,b;f=Jencil.editor.DualPaneEditorBase;d=Jencil.editor.pane.PreviewPane;b=Jencil.editor.pane.TextareaPane;return h.TextEditor=function(){function e(c){var a,g;(a=c.options.extras.previewPosition)==="top"||a==="left"?(a=this.preview=new d(c,this),g=this.textarea=new b(c,this)):(a=this.textarea=new b(c,this),g=this.preview=new d(c,this));e.__super__.constructor.call(this,c,"jencil-text-editor",a,g);this.$element.addClass("jencil-preview-position-"+
this.jencil.options.extras.previewPosition);this.setValue(this.jencil.getSourceValue());this.jencil.options.extras.defaultPreviewState==="close"&&this.preview.hide();this.textarea.update(k(function(){this.jencil.setSourceValue(this.getValue());return this.preview.update()},this))}j(e,f);e.extras={options:{previewPosition:"right",previewTemplatePath:"~/extras/templates/preview.html",defaultPreviewState:"open"}};e.prototype.relocate=function(){e.__super__.relocate.call(this);if(Jencil.utils.detector.browser===
"Explorer"&&Jencil.utils.detector.version===8)return document.selection.createRange().select()};e.prototype.getValue=function(){return this.textarea.getValue()};e.prototype.setValue=function(b){return this.textarea.setValue(b)};e.prototype.getSelection=function(){return this.textarea.controller.getSelection()};e.prototype.setSelection=function(b,a){return this.textarea.controller.setSelection(b,a)};e.prototype.getSelected=function(){return this.textarea.controller.getSelected()};e.prototype.replaceSelected=
function(b,a){a==null&&(a=!1);return this.textarea.controller.replaceSelected(b,a)};e.prototype.insertBeforeSelected=function(b,a){a==null&&(a=!1);return this.textarea.controller.insertBeforeSelected(b,a)};e.prototype.insertAfterSelected=function(b,a){a==null&&(a=!1);return this.textarea.controller.insertAfterSelected(b,a)};e.prototype.wrapSelected=function(b,a,d,e){d==null&&(d=!1);e==null&&(e=void 0);return this.textarea.controller.wrapSelected(b,a,d,e)};return e}()});namespace("Jencil.button",function(h){var f,
d;f=Jencil.button.ButtonBase;h.MarkupButtonBase=d=function(){function b(){b.__super__.constructor.apply(this,arguments)}j(b,f);b.prototype.clickAfter=function(){return this.editor().update()};return b}();h.SimpleMarkupButton=function(){function b(d,c){var a,g;a=c[0];g=c[1];this.before=c[2];this.after=c[3];this.insert=c[4];b.__super__.constructor.call(this,d,a,g)}j(b,d);b.prototype.click=function(){return this.editor().wrapSelected(this.before,this.after,!0,this.insert||this.jencil.options.defaultInsertText)};
return b}();h.MultilineMarkupButton=function(){function b(d,c){var a,g;a=c[0];g=c[1];this.before=c[2];this.after=c[3];this.blockBefore=c[4];this.blockAfter=c[5];b.__super__.constructor.call(this,d,a,g)}j(b,d);b.prototype.click=function(){var b,c,a,d,f,h,i;d=this.editor().getSelected().split("\n");a=d[0]===this.blockBefore?1:0;for(b=0,i=d.length;0<=i?b<i:b>i;0<=i?b++:b--)h=Jencil.utils.string.format(this.before,{i:b+1-a}),f=Jencil.utils.string.format(this.after,{i:b+1-a}),c=d[b],c===this.blockBefore||
c===this.blockAfter||(d[b]=c.startsWith(h)&&c.endsWith(f)?c.substring(h.length,c.length-f.length):""+h+c+f);this.blockBefore!==void 0&&(d[0]===this.blockBefore?d.shift():d.unshift(this.blockBefore));this.blockAfter!==void 0&&(d[d.length-1]===this.blockAfter?d.pop():d.push(this.blockAfter));b=d.join("\n");return this.editor().replaceSelected(b,!0)};return b}();h.LinkMarkupButton=function(){function b(d,c){this.formatstr=c[0];b.__super__.constructor.call(this,d,"link","Link")}j(b,d);b.prototype.click=
function(){var b,c,a;b=prompt("Please input link url");if(b!==null&&(c=prompt("Please input link label",this.editor().getSelected()),c!==null&&(a=prompt("(Optional) Please input link title"),a!==null)))return b=Jencil.utils.string.format(this.formatstr,{href:b,label:c,title:a}),this.editor().replaceSelected(b)};return b}();return h.ImageMarkupButton=function(){function b(d,c){this.formatstr=c[0];b.__super__.constructor.call(this,d,"image","Image")}j(b,d);b.prototype.click=function(){var b,c,a;c=prompt("Please input image src url");
if(c!==null&&(b=prompt("(Optional) Please input image alt label",this.editor().getSelected()),b!==null&&(a=prompt("(Optional) Please input image title"),a!==null)))return b=Jencil.utils.string.format(this.formatstr,{src:c,alt:b,title:a}),this.editor().replaceSelected(b)};return b}()});namespace("Jencil.editor.pane",function(h){var f;f=Jencil.editor.pane.EditorPane;return h.RichareaPane=function(){function d(b,e){var c;d.__super__.constructor.call(this,b,"jencil-richarea-pane",e);this.$element.css({position:"relative"});
this.$surface=i("<iframe>").addClass("surface");this.$surface.appendTo(this.$element);this.$surface.css({width:"100%",height:"100%",border:"none",margin:0,padding:0});if(this.jencil.options.extras.richareaTemplatePath!=null)c=this.jencil.options.extras.richareaTemplatePath,this.$surface.attr("src",Jencil.utils.path.abspath(c));Jencil.utils.detector.browser==="Explorer"&&this.$surface.attr("frameborder",0);this.controller=null}j(d,f);d.prototype.init=function(){this.controller=new Richarea(this.$surface);
return this.controller.ready(k(function(){this.relocate();this.$body=i(this.controller.raw.body);this.$body.css({margin:0,padding:0});i(this.controller.raw.iframe).bind("keyup keypress change click blur enter",k(function(){return this.update()},this));return d.__super__.init.call(this)},this))};d.prototype.relocate=function(){d.__super__.relocate.call(this);Jencil.utils.detector.browser==="Explorer"&&Jencil.utils.detector.version<8&&this.$surface.height(this.$element.height());if(Jencil.utils.detector.browser===
"Explorer"&&Jencil.utils.detector.version<9)return this.$body.height(this.$surface.height())};d.prototype.getValue=function(){var b;if((b=this.controller)!=null&&b.ready())return this.controller.getValue()};d.prototype.setValue=function(b){var d;if((d=this.controller)!=null&&d.ready())return this.controller.setValue(b)};return d}()});namespace("Jencil.editor",function(h){var f,d,b;f=Jencil.editor.DualPaneEditorBase;b=Jencil.editor.pane.TextareaPane;d=Jencil.editor.pane.RichareaPane;return h.RichEditor=
function(){function e(c){var a,f;(a=c.options.extras.previewPosition)==="top"||a==="left"?(a=this.preview=new b(c,this),f=this.richarea=new d(c,this)):(a=this.richarea=new d(c,this),f=this.preview=new b(c,this));e.__super__.constructor.call(this,c,"jencil-rich-editor",a,f);this.$element.addClass("jencil-preview-position-"+this.jencil.options.extras.previewPosition);this.jencil.options.extras.defaultPreviewState==="close"&&this.preview.hide()}j(e,f);e.extras={options:{richareaTemplatePath:"~/extras/templates/richarea.html"}};
e.prototype.init=function(){e.__super__.init.call(this);return this.richarea.controller.ready(k(function(){this.setValue(this.jencil.getSourceValue());this.preview.setValue(this.getValue());this.richarea.update(k(function(){this.jencil.setSourceValue(this.getValue());return this.preview.setValue(this.getValue())},this));this.preview.update(k(function(){this.jencil.setSourceValue(this.preview.getValue());return this.richarea.setValue(this.preview.getValue())},this));return this.update()},this))};e.prototype.getValue=
function(){return this.richarea.getValue()};e.prototype.setValue=function(b){return this.richarea.setValue(b)};return e}()});namespace("Jencil.button",function(h){var f,d;d=Jencil.button.MarkupButtonBase;h.CommandButton=f=function(){function b(d,c){var a,f;f=c[0];a=c[1];this.command=c[2];this.args=c[3];b.__super__.constructor.call(this,d,f,a)}j(b,d);b.prototype.click=function(){return this.exec(this.command,this.args)};b.prototype.exec=function(b,c){if(this.editor().richarea.controller!=null)return this.editor().richarea.controller.execCommand(b,
c)};return b}();return h.PromptCommandButton=function(){function b(d,c){var a,f,h;h=c[0];a=c[1];f=c[2];this.message=c[3];this.defaultValue=c[4];b.__super__.constructor.call(this,d,[h,a,f,void 0])}j(b,f);b.prototype.click=function(){var b;b=prompt(this.message,this.defaultValue||"");return b===null?void 0:this.exec(this.command,b)};return b}()})}).call(this);
