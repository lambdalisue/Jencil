(function() {
  ...
  */
  ...
  namespace('Jencil.loader', function(exports) {
    ...
    return exports.Loader = Loader = (function() {
      /*
          ...
          */      function Loader(textarea) {
        var _ref;
        this.$element = $('<div>').addClass('jencil-loader').hide();
        this.$textarea = $(textarea);
        this.$textarea.after(this.$element);
        this.$textarea.hide();
        if ((_ref = Jencil.options.documentTypeElement) != null) {
          _ref.hide();
        }
        this.$element.show();
      }
      Loader.prototype.dispose = function() {
        var _ref;
        this.$element.remove();
        return (_ref = Jencil.options.documentTypeElement) != null ? _ref.show() : void 0;
      };
      return Loader;
    })();
  });
  ...
  $.fn.jencil = function(options) {
    var i, loaders, requires, _ref, _ref2, _ref3, _ref4, _ref5;
    options = $.extend(true, {
      root: void 0,
      ...
      requires: [['~/textarea.min.js', 'window.Textarea'], ['~/jencil.core.min.js', 'window.Jencil.core'], ['~/jencil.widgets.min.js', 'window.Jencil.widgets'], ['~/jencil.buttons.min.js', 'window.Jencil.buttons'], ['~/jencil.editors.min.js', 'window.Jencil.editors']],
      editors: [['~/editors/jencil.texteditor.min.js', 'window.Jencil.editors.TextEditor']],
      extras: [['http://teddevito.com/demos/js/jquery.textarea.js', '$.fn.tabby']]
    }, options);
    ...
    for (i = 0, _ref5 = options.extras.length; 0 <= _ref5 ? i < _ref5 : i > _ref5; 0 <= _ref5 ? i++ : i--) {
    ...
    loaders = [];
    this.each(function() {
      return loaders.push(new Jencil.loader.Loader(this));
    });
    ...
    return net.hashnote.module.loadall(requires, __bind(function() {
      ...
      return this.each(function() {
        return new Jencil.core.JencilCore($(this));
      });
    }, this));
  };
}).call(this);
