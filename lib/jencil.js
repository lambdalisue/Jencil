(function() {
  ...
  */
  ...
  namespace('Jencil.theme', function(exports) {
    var abspath, load, loadEditorCSS;
    exports.root = void 0;
    ...
    exports.load = load = function(name) {
      var jencil, media, url, _i, _len, _ref, _results;
      ...
      if (Jencil.jencils != null) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          jencil = _ref[_i];
          _results.push(loadEditorCSS(jencil.editor().constructor));
        }
        return _results;
      }
    };
    return exports.loadEditorCSS = loadEditorCSS = function(editorClass) {
      var media, stylesheet, url, _i, _len, _ref, _results;
      if (editorClass.stylesheets != null) {
        _ref = editorClass.stylesheets;
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          stylesheet = _ref[_i];
          url = stylesheet[0], media = stylesheet[1];
          url = abspath(url);
          if (media == null) {
            media = 'screen, projection';
          }
          _results.push(net.hashnote.css.include(url, media));
        }
        return _results;
      }
    };
  ...
  namespace('Jencil.loader', function(exports) {
    ...
    return exports.Loader = Loader = (function() {
      /*
        ...
        this.$element = $('<div>').addClass('jencil-loader');
  ...
  $.fn.jencil = function(options) {
    ...
    options = $.extend(true, {
      ...
      extras: {},
      requires: [['~/textarea.min.js', 'window.Textarea'], ['~/jencil.core.min.js', 'window.Jencil.core'], ['~/jencil.widgets.min.js', 'window.Jencil.widgets'], ['~/jencil.buttons.min.js', 'window.Jencil.buttons'], ['~/jencil.editors.min.js', 'window.Jencil.editors'], ['~/jencil.profile.min.js', 'window.Jencil.profile']],
      editors: [['~/editors/jencil.texteditor.min.js', 'window.Jencil.editors.TextEditor']]
    }, options);
