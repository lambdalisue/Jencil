(function() {
  ...
  */
  ...
  $.fn.jencil = function(options) {
    var $$, $loading, i, requires, _ref, _ref2, _ref3, _ref4, _ref5;
    options = $.extend(true, {
      root: void 0,
      ...
      requires: [['~/textarea.min.js', 'window.Textarea'], ['~/jencil.core.min.js', 'window.Jencil'], ['~/jencil.widgets.min.js', 'window.Jencil.widgets'], ['~/jencil.buttons.min.js', 'window.Jencil.buttons'], ['~/jencil.editors.min.js', 'window.Jencil.editors'], ['~/editors/jencil.texteditor.min.js', 'window.Jencil.editors.TextEditor'], ['~/editors/jencil.richeditor.min.js', 'window.Jencil.editors.RichEditor']],
    ...
    $$ = $(this);
    $$.hide();
    if ((_ref2 = options.documentTypeElement) != null) {
      _ref2.hide();
    }
    $loading = $('<div>').addClass('jencil-loading');
    $$.after($loading);
    if ((_ref3 = options.root) == null) {
    ...
    for (i = 0, _ref4 = options.requires.length; 0 <= _ref4 ? i < _ref4 : i > _ref4; 0 <= _ref4 ? i++ : i--) {
    ...
    return net.hashnote.module.loadall(requires, __bind(function() {
      var _ref6;
      $loading.remove();
      if ((_ref6 = options.documentTypeElement) != null) {
        _ref6.show();
      }
