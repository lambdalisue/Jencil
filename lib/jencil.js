 ...
 *   Copyright (c) 2011 hashnote.net, Alisue allright reserved
 * 
 * Last-Modified: Thu, 06 Oct 2011 15:41:51 GMT
 */
(function() {
  /*
  ...
  */
  namespace('Jencil.editor.pane', function(exports) {
    ...
    return exports.PreviewPane = PreviewPane = (function() {
      ...
      PreviewPane.prototype.init = function() {
        var iframe;
        iframe = this.$surface.get(0);
        if (iframe.contentDocument != null) {
          this._document = iframe.contentDocument;
        } else {
          this._document = iframe.contentWindow.document;
        }
        this._document.write('<body></body>');
        return PreviewPane.__super__.init.call(this);
      };
      PreviewPane.prototype._writeContent = function(content) {
        ...
        process = __bind(function(template) {
          ...
          if (this._document != null) {
            try {
              scrollTop = this._document.documentElement.scrollTop;
            } catch (e) {
              scrollTop = 0;
            }
            this._document.open();
            this._document.write(template.replace('{{content}}', content));
            this._document.close();
            return this._document.documentElement.scrollTop = scrollTop;
          }
        }, this);
