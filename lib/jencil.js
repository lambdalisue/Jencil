(function() {
  ...
  */
  ...
  namespace('Jencil.utils', function(exports) {
    ...
    return exports.browser = new Browser;
  });
  ...
  $.fn.jencil = function(options) {
    ...
    options = $.extend(true, {
      ...
      extras: {},
      requires: [['~/jencil.core.js', 'window.Jencil.core'], ['~/jencil.widgets.js', 'window.Jencil.widgets'], ['~/jencil.buttons.js', 'window.Jencil.buttons'], ['~/jencil.editors.js', 'window.Jencil.editors'], ['~/jencil.profile.js', 'window.Jencil.profile']],
      editors: [['~/editors/jencil.texteditor.js', 'window.Jencil.editors.TextEditor'], ['~/editors/jencil.richeditor.js', 'window.Jencil.editors.RichEditor']]
    }, options);
