(function() {
  ...
  */
  var Initializer, Rawview, RichArea, isIE6, isIE7;
  ...
  RichArea = (function() {
    ...
    RichArea.prototype.init = function() {
      ...
      return this.controller.ready(__bind(function() {
        ...
        this.$surface.bind('click', __bind(function() {
          alert("Clicked");
          return this.controller.raw.body.focus();
        }, this));
    ...
    RichArea.prototype.getValue = function() {
      var _ref;
      if ((_ref = this.controller) != null ? _ref.isReady() : void 0) {
    ...
    return exports.RichEditor = RichEditor = (function() {
      ...
      RichEditor.prototype.reconstruct = function() {
        ...
        if (isIE6 || isIE7) {
          ...
          return this.rawview.$surface.height(this.rawview.$element.height());
        }
      };
  ...
  namespace('Jencil.buttons', function(exports) {
    ...
    exports.CommandButton = CommandButton = (function() {
      ...
      CommandButton.prototype.exec = function(command, value) {
        var _ref;
        if (this.editor().richarea.controller) {
