  ...
  */
  ...
  namespace('Jencil.editors', function(exports) {
    ...
    return exports.TextEditor = TextEditor = (function() {
      ...
      TextEditor.stylesheets = [['~/jencil.texteditor.css', 'screen, projection']];
      TextEditor.requires = [['http://teddevito.com/demos/js/jquery.textarea.js', '$.fn.tabby']];
      TextEditor.options = {
        previewPosition: 'right',
        previewTemplatePath: '~/templates/preview.html'
      };
      TextEditor.setUp = function(jencil) {
        return TextEditor.options.previewTemplatePath = net.hashnote.path.abspath(TextEditor.options.previewTemplatePath, jencil.options.root);
      };
      function TextEditor(jencil) {
        TextEditor.__super__.constructor.call(this, jencil, 'jencil-text-editor', 'div');
        this.$element.addClass("preview-position-" + this.jencil.options.extras.previewPosition);
