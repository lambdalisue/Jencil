  ...
  */
  ...
  $.fn.jencil = function(options) {
    ...
    options = $.extend(true, {
      ...
      requires: [['js/textarea.min.js', 'window.Textarea'], ['~/jencil.core.min.js', 'window.Jencil'], ['~/jencil.widgets.min.js', 'window.Jencil.widgets'], ['~/jencil.buttons.min.js', 'window.Jencil.widgets.Button'], ['~/jencil.texteditor.min.js', 'window.Jencil.editors.TextEditor'], ['~/jencil.richeditor.min.js', 'window.Jencil.editors.RichEditor']],
      extras: []
    }, options);
