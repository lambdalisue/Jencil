(function() {
  ...
  describe('Jencil.workspace.Workspace(core) extends Panel -> instance', function() {
    var core, sandbox;
    sandbox = null;
    core = {
      options: {
    ...
    it('should be found on `Jencil.workspace.Workspace`', function() {
      return Workspace.should.be.equal(Jencil.workspace.Workspace);
    });
    it('should add `workspace` class', function() {
      var instance;
      instance = new Workspace(null);
      return instance.element.hasClass('workspace').should.be["true"];
    });
    return describe('#profile(profileNameOrInstance) => instance | profile', function() {
      var instance;
      instance = new Workspace(core);
      it('should be an instance property', function() {
        return instance.should.have.property('profile').a('function');
      });
      return it('should construct workspace with the profile', function() {
        return instance.profile('Html').should.be.equal(instance);
      });
    });
  });
