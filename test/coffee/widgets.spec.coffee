...
describe 'Jencil.widgets.MultiplePanel(core, fst, snd, splitter) extends Panel -> instance', ->
  ...
  describe '#init() -> instance', ->
    ...
    it 'should call `init` method of fst, snd and splitter', sinon.test ->
      mock1 = @mock(fst).expects('init').once()
      mock2 = @mock(snd).expects('init').once()
      mock3 = @mock(splitter).expects('init').once()
      instance.init()
  ...
  describe '#fst.show() -> instance', ->
    ...
    it 'should make fst to be visible 500ms after called', sinon.test ->
      @stub(fst.element, 'is', -> @css('display') is 'block')
      splitter.volume 0
  ...
  describe '#fst.hide() -> instance', ->
    ...
    it 'should make fst to be unvisible 500ms after called', sinon.test ->
      @stub(fst.element, 'is', -> @css('display') is 'block')
      splitter.volume 0.5
      fst.element.css('display').should.be.equal('block')
      fst.hide()
  ...
  describe '#fst.toggle() -> instance', ->
    ...
    it 'should toggle visibility of fst 500ms after called', sinon.test ->
      @stub(fst.element, 'is', -> @css('display') is 'block')
      fst.hide()
      @clock.tick(500)
      fst.toggle()
  ...
  describe '#snd.show() -> instance', ->
    ...
    it 'should make snd to be visible 500ms after called', sinon.test ->
      @stub(snd.element, 'is', -> @css('display') is 'block')
      splitter.volume 1
  ...
  describe '#snd.hide() -> instance', ->
    ...
    it 'should make snd to be unvisible 500ms after called', sinon.test ->
      @stub(snd.element, 'is', -> @css('display') is 'block')
      splitter.volume 0.5
      snd.element.css('display').should.be.equal('block')
      snd.hide()
  ...
  describe '#snd.toggle() -> instance', ->
    ...
    it 'should toggle visibility of snd 500ms after called', sinon.test ->
      @stub(snd.element, 'is', -> @css('display') is 'block')
      snd.hide()
      @clock.tick(500)
      snd.toggle()
